...
export async function saveAssessment(data, isRetest = false) {
  try {
    console.log("💾 Saving assessment:", data, "isRetest:", isRetest);
    const processedData = {
      ...data,
      submittedAt: data.submittedAt || new Date().toISOString(),
      is_retest: isRetest  // ★ 新增重新測驗標記
    };
...
export async function saveAssessmentMBTI(mbtiString, encodedArray, isRetest = false) {
  console.log("💾 Saving MBTI:", { mbtiString, encodedArray, isRetest });
  try {
