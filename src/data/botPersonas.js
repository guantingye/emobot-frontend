...
const personas = {
  empathy: {
    ...
    color: "#FF8FB1",
    story:
      "Lumi 擅長傾聽與陪伴，能聽見人心細語。她的使命是伴隨每個孤單的靈魂，給予溫柔與安全感。",
  ...
  insight: {
    ...
    color: "#5A8CF2",
    story:
      "Solin 是一位思想開放的引導者，帶著手札與筆，幫人看見隱藏的線索。他不給答案，而是開啟新的提問。",
  ...
  solution: {
    ...
    color: "#3AA87A",
    story:
      "Niko 是行動派導師，擅長把複雜問題拆成清晰步驟，幫你找到能立刻動手做的解法。",
  ...
  cognitive: {
    ...
    color: "#7A4DC8",
    story:
      "Clara 是冷靜的實務型夥伴，擅長用理性與框架幫助你看見思考盲點，完成認知重構。",
